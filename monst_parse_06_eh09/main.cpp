...
int main()
{
    ...
    while(mons[x].mname[0]!='\0')
    {
        ...
        if(strcmp(mons[x].mname,"mind flayer")==0||
           ...
           strcmp(mons[x].mname,"illithid")==0)
            fout<<"GAIN_IN=50|";
        if(strcmp(mons[x].mname,"displacer beast")==0)
            fout<<"DISPLACEMENT=100|";
        if(strcmp(mons[x].mname,"magical eye")==0)
            fout<<"LUCK=100|";
        ...
        if(strcmp(mons[x].mname,"chickatrice")==0||
           ...
           strcmp(mons[x].mname,"basilisk")==0||
        ...
        if(mons[x].mflags1&M1_POIS)
            fout<<"POISON=100|";
        if(mons[x].mhflags&MH_HUMAN)
            fout<<"HUMAN=100|";
        if(mons[x].mhflags&MH_ELF)
            fout<<"ELF=100|";
        if(mons[x].mhflags&MH_DROW)
            fout<<"ELF=100|";
        if(mons[x].mhflags&MH_DWARF)
            fout<<"DWARF=100|";
        if(mons[x].mhflags&MH_GNOME)
            fout<<"GNOME=100|";
        if(mons[x].mhflags&MH_GIANT)
            fout<<"GIANT=100|";
        if(mons[x].mhflags&MH_CENTAUR)
            fout<<"CENTAUR=100|";
        if(mons[x].mhflags&MH_HOBBIT)
            fout<<"HOBBIT=100|";
        if(mons[x].mhflags&MH_ILLITHID)
            fout<<"ILLITHID=100|";
        if(mons[x].mhflags&MH_TORTLE)
            fout<<"TORTLE=100|";
        //draugr and orc are allowed to cannibal
        fout<<"-,";
